...
\
        ...
        <script>
            "use strict";
                    ...
                    if (t) {
                        ...
                        new Chart(e, {
                            ...
                            data: {
                                datasets: [
                                    {
                                        data: [{!! json_encode($datawim) !!}, {!! json_encode($datalidar) !!}, {!! json_encode($datawim2) !!}],
                                        backgroundColor: [
                                            "#00A3FF",
                                            "#ffff00",
                                            "#E4E6EF",
                                ...
                                labels: ["Berat Lebih", "Dimensi Lebih", "Tidak Ada Plat Nomor"],
                            },
                            options: {
                ...
                //                 type: "bar",
                //                 stacked: !0,
                //                 data: [40, 50, 65, 70, 50, 30, 20, 20, 20, 20, 15, 32],
                //             },
                //             {
                //                 name: "Revenue",
                //                 type: "bar",
                //                 stacked: !0,
                //                 data: [20, 20, 25, 30, 30, 20, 20, 20, 20, 20, 15, 32],
                //             },
                //             {
                //                 name: "Expenses",
                //                 type: "area",
                //                 data: [50, 80, 60, 90, 50, 70, 20, 20, 20, 20, 15, 32],
                //             },
                //         ],
                //         chart: {
                //             fontFamily: "inherit",
                ...
                var labelColor = KTUtil.getCssVariableValue('--bs-gray-100');
                var borderColor = KTUtil.getCssVariableValue('--bs-gray-100');
                var baseColor = KTUtil.getCssVariableValue('--bs-warning');
                var secondaryColor = KTUtil.getCssVariableValue('--bs-gray-100');
                var textColor = KTUtil.getCssVariableValue('--bs-gray-100');
                ...
                var options = {
                    series: [{
                        ...
                        data: [{!! json_encode($datajanuari) !!}, {!! json_encode($datafebruari) !!}, {!! json_encode($datamaret) !!}, {!! json_encode($dataapril) !!}, {!! json_encode($datamei) !!},
                        {!! json_encode($datajuni) !!}, {!! json_encode($datajuli) !!}, {!! json_encode($dataagustus) !!}, {!! json_encode($dataseptember) !!}, {!! json_encode($dataoktober) !!},
                        {!! json_encode($datanovember) !!}, {!! json_encode($datadesember) !!}],
                    }, {
                        name: 'Melanggar',
                        data: [{!! json_encode($datamelanggarjanuari) !!}, {!! json_encode($datamelanggarfebruari) !!}, {!! json_encode($datamelanggarmaret) !!}, {!! json_encode($datamelanggarapril) !!},
                        {!! json_encode($datamelanggarmei) !!}, {!! json_encode($datamelanggarjuni) !!}, {!! json_encode($datamelanggarjuli) !!}, {!! json_encode($datamelanggaragustus) !!},
                        {!! json_encode($datamelanggarseptember) !!}, {!! json_encode($datamelanggaroktober) !!} ,{!! json_encode($datamelanggarnovember) !!}, {!! json_encode($datamelanggardesember) !!}]
                    }],
                    chart: {
                        fontFamily: 'inherit',
                        type: 'bar',
                    ...
                    xaxis: {
                        categories: ['Januari','Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agutus', 'September', 'Oktober', 'November', 'Desember'],
                        axisBorder: {
                            show: false,
                        },
                        axisTicks: {
