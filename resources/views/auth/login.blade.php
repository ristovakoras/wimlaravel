...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header-home">{{ __('Login') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" placeholder="Masukkan Alamat Email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('image/logo_kemenhub.png') }}" rel="icon">
            ...
            <div class="col-lg-12">
                <div class="form-container">
                    ...
                    <div class="right-content">
                        <h3 class="form-title text-center">{{ __('WIM MONITORING SYSTEM') }}</h3>
                            <div class="form-horizontal">
                                <form method="POST" action="{{ route('login') }}">
                                    @csrf
                                    <div class="form-group">
                                        <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('User Ids') }}</label>
                                        <input id="email" type="email" placeholder="Masukkan Alamat Email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    ...
                                    <button type="submit" class="btn signin">{{ __('Masuk') }}</button>
                                 </form>
                            </div>
                    </div>
                </div>
